...
var learnMoreToggle = false;

function learnMore(){
    if (!learnMoreToggle){
        document.getElementById("learnMoreFooterDiv").classList.remove("hidden");
        learnMoreToggle = true;
    } else {
        document.getElementById("learnMoreFooterDiv").classList.add("hidden");
